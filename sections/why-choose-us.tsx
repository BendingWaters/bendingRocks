        ...
        <section className="py-16 mt-28 px-4 md:px-16 lg:px-24 xl:px-32 w-full bg-gray-50">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 lg:gap-24">
                ...
                <div className="flex flex-col">
                    ...
                    >
                        Pretty Is Not a Business Model
                    </motion.h2>
                ...
                <div className="flex flex-col justify-between">
                    <motion.p className="text-zinc-500 text-sm md:text-base max-w-115 md:mt-20 mb-8"
                        ...
                        transition={{ delay: 0.2, type: "spring", stiffness: 320, damping: 70, mass: 1 }}
                    >
                        A development can look premium and still be commercially forgettable. We combine strategy, culture, creativity and sales thinking so that every decision has a reason — and every deliverable has a job. No beige brands. No empty luxury language. No design without direction.
                    </motion.p>
